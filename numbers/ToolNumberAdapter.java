...
public abstract class ToolNumberAdapter<C extends ToolNumber>
     ...
     */
    @SuppressWarnings("unchecked") // <this> instanceof C.
     ...
     */
    @Override
    @SuppressWarnings("unchecked") // <ToolNumber> instanceof T.
    public <T extends ToolNumber> T add(Number num) {
        return (T) addTool(this, convert(num), null);
    }
    
    @Override
    @SuppressWarnings("unchecked") // <this> instanceof ToolNumber.
    ...
    @Override
    @SuppressWarnings("unchecked") // <this> instanceof T/C, <C> instanceof T.
