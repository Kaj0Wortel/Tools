...
public class PrimitiveNumber<N extends Number>
     ...
     */
    public Class<? extends Number> calcWidestType(Class<? extends Number> c1,
    ...
    public static Object toPrimNumber(Object obj) {
        if (obj.getClass().isArray()) {
            Object[] result = (Object[]) Array.newInstance
                (PrimitiveNumber.class, MultiTool.calcDimArray(obj));
     ...
     * 
     * See {@link ToolNumberOperationAdapter#doOperation(Number, Number,
    ...
    protected <T extends ToolNumber> T doOperation
        ...
        if (cast.equals(Byte.class)) {
            ...
            updateValue = (Double) result.doubleValue();
    ...
    public static void main(String[] args) {
        // todo:
        //PrimitiveNumber<Integer> num = new PrimitiveNumber<>(10);
        //System.out.println(num.addi(0.5));
        //System.out.println(num);
        /*
        Integer a = 11;
        Double b = 2.0;
        System.out.println(11/2);
        System.out.println((int) (a.doubleValue() / b.doubleValue()));
        PrimitiveNumber<Integer> num = new PrimitiveNumber<>(1);
        System.out.println(num.doOperation(a, b, Operation.DIV, true));
        System.out.println(num);*/
        
        
        PrimitiveNumber<Integer> num = new PrimitiveNumber<>(11);
        PrimitiveNumber<Double> num2 = new PrimitiveNumber<>(2.0);
        System.out.println(num);
        System.out.println(num.add(num2));
        System.out.println(num);
        System.out.println(num.addi(num2));
        System.out.println(num);
        System.out.println("------------");
        System.out.println(num.div(num2));
        System.out.println(num);
        System.out.println(num.divi(num2));
        System.out.println(num);
        
        num = new PrimitiveNumber<>(2);
        num2 = new PrimitiveNumber<>(11.0);
        System.out.println("------------");
        System.out.println(num2.div(num));
        System.out.println(num2);
        System.out.println(num2.divi(num));
        System.out.println(num2);
        System.out.println(new tools.matrix.Mat(10).add(num));
    }
